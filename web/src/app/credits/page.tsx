...
const S: Record<string, React.CSSProperties> = {
  ...
  summary: { background: "#241B2D", border: "1px solid #3A2E44", borderRadius: 16, padding: "22px 24px", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 14 },
  ...
  pack: { display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 4, background: "#241B2D", border: "1px solid #3A2E44", borderRadius: 14, padding: "16px 18px", cursor: "pointer", textAlign: "left" },
