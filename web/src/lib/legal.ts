...
// ReverieTale is currently operated by an individual (no separate registered
...
// it up.
export const OPERATOR_NAME = "ReverieTale";
...
// ReverieTale is a 13+ fictional-story platform. Character age still belongs
